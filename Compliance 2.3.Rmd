...
# initial_report_date <- mdy("11/19/2018")
```
...
if (exists("initial_report_date")) {
  ...
  initial_report <- 
    initial_report %>% 
    filter(report_date == initial_report_date,
...
compliance_report <- 
  ...
  select(report_date, name, salesforce_id, missing_exp, missing_rev, missing_w2,
         last_uploaded_batch, last_processed_batch, 
         unexpired_temporary_exemption, send_60_day_notice, 
         still_missing_noticed_report, grace_period_expired, upload_in_queue, 
         catch_next_cycle, analyst_note)
