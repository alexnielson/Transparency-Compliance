---
title: "Transparency Compliance 2.3"
...
* DSN name for the Salesforce and AWS ODBCs.

Additionally, Transparency IDs are required in the section titled "Compliance Report - Select Governments" if the report is for a single government or a handful of governments.
...
```{r, eval=FALSE}
vector_of_t_ids <- 
  c(1500, 1522, 1541, 1539, 1523, 1485, 1410)
