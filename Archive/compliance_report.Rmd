...
# uploaded. This report, called `naught_list`, is used as a check against 
...
# Create a report of the entities that are missing three or more quarters of 
# expense or revenue data or that are missing more than one year of payroll
# data. Use this report to focus our efforts on entities that are 
# missing the most information on Transparency.
...
if (!exists("subset_of_entities")) {
  ...
  extra_naughty_list %>% 
    write_csv(
      path = paste0(file_path, Sys.Date(), " Need Extra Attention.csv"),
      na = "")
}
```
