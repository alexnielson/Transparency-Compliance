---
title: "Transparency Compliance 2.2 - Many Entities"
...
For each active and participating entity that OSA will monitor for Transparency compliance, report the fiscal periods for which the entity has not complied with the following reporting requirements and does not have a permanent reporting exemption:
...
## Compliance Report - All Entities
...
compliance_report <- 
  ...
  select(report_date, name, salesforce_id, missing_exp, missing_rev, missing_w2,
         ...
         still_missing_noticed_report, analyst_note)
...
## Compliance Report - Selected Entities
...
file_name <- paste0("Okay to Hold Review",".csv")
